...
import { IAPIResponse, getPopular, makeImagePath, makeBgPath, getMovie, IMovieDetail } from "../api";
                            ...
                            {moviePathMatch ? (
                                <>
                                    <Overlay 
                                        ...
                                        animate={{opacity: 1}}    
                                    />
                                    <MovieModal layoutId={moviePathMatch.params.id + "p"} style={{backgroundColor: "rgba(0,0,0,1"}}>
                                        {clickedMovie && (
                                            <>
